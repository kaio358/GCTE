...
function Linha_tabela(props){
    ...
    if(!props.eventoLapis){
        if(mudou){
          ...
          fetch("http://ec2-44-201-229-29.compute-1.amazonaws.com:5000/pessoa/atualizar",{
            method:"PUT",
            body: JSON.stringify({
              id: props.id,
    ...
    function enviarParaServidor(teste) {
        ...
        fetch("http://ec2-44-201-229-29.compute-1.amazonaws.com:5000/pagamento/confirmacao", {
          method: "PUT",
          body: JSON.stringify({
